...
class IAidDicomLib {
    ...
    constructor() {
        ...
        this.DicomDataList.elemnet = new Array();
        this.DicomDataList.sequnce = null;
        ...
        try {
            ...
            while (flagEnd) {
                ...
                if (this.vr === 'SQ') {
                    ...
                    this.DicomDataList.elemnet[tmpdata.tag] = tmpdata;
                    ...
                    console.log(value);
                    //  console.log(value);
                    this.DicomDataList.elemnet[value.tag] = value;
                }
            }
        }catch(e){
    ...
    getNextTag()
    {
        ...
        console.log("groupWord : " + this.readHex(groupWord));
        console.log("elementWord : " + this.readHex(elementWord));
    ...
    getTagValue(tmptag)
    {
        let output = '';
        try {
            output =this.DicomDataList.elemnet[tmptag].value;
        }catch (e) {
            return 'undefined';
        }
        return output;
    ...
    readPixelData()
    {
        ...
        if (  this.getTagValue('0x00280100') !== 'undefined' ) {
            bitsAllocated = this.DicomDataList.elemnet['0x00280100'].value;
        } else {
        ...
        if (  this.getTagValue('x00280103') !== 'undefined' ) {
            pixelRepresentation = this.DicomDataList.elemnet['x00280103'].value;
        } else {
        ...
        if ( bitsAllocated === 8 ) {
            ...
            if (pixelRepresentation === 0) {
                this.pixelData = new BigUint64Array(this.byteBuffer, this.location, this.elemnetLength/16);
            }
            else {
                this.pixelData = new BigInt64Array(this.byteBuffer, this.location, this.elemnetLength/16);
            }
        }
    ...
    getImagedata()
    {
        ...
        let iWindowWidth = 2325;
        let iwindowCenter = 139;
       ...
       // b0*dRescaleSlope+dRescaleIntercept;
        ...
        for(let idx=0; idx<this.pixelData.length;idx++)
        {
            ...
            let recondata = (this.pixelData[idx]*Number(dRescaleSlope))+Number(dRescaleIntercept);
           ...
           if(recondata<= imin)
                ...
                imagePixelData[idx] = recondata;
            }
        }

      /*  for(let idx=0; idx<imagePixelData.length;idx++)
        {
            console.log(idx + " "+ imagePixelData[idx]);
        }*/
